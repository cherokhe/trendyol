<?php
	...
	class Wc_Trendyol_Admin{
		...
		public function get_pagination_html($total_pages = 0, $active_page = 1, $page_limit = 10){
		...
		public function get_wc_products($category_id = 0, $paged = 1, $limit = 10, $parent_id = 0, $post_status = '*', $stock_status = '*'){
			...
			// Eğer kategori seçilmişse filtrele
			if($category_id > 0){
				$args['tax_query'] = [
					[
			...
			foreach($products as $product){
				...
				// Eğer ürün varyasyon içeriyorsa, varyasyonları çek
		...
		public function get_wc_products_total($category_id = 0, $parent_id = 0, $post_status = '*', $stock_status = '*'){

			$args         = [
				'post_type'      => ['product'],
				'posts_per_page' => -1, // Tüm ürünleri çek
				'orderby'        => 'title',
				'order'          => 'ASC',
			];
